...
$sql = "SELECT * FROM feeds_stocks";
$result = $conn->query($sql);


if ($result->num_rows > 0) {
    echo "<div class='container mt-4'>";
    echo "<h2>Feeds Stocks</h2>";
    echo "<table class='table table-bordered table-striped'>";
    echo "<thead class='thead-light'>";
    echo "<tr><th>ID</th><th>Date</th><th>Sack Kilo</th><th>No of Sack</th><th>Total Kilo</th></tr>";
    echo "</thead>";
    echo "<tbody>";
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row['id'] . "</td>";
        echo "<td>" . $row['date'] . "</td>";
        echo "<td>" . $row['sack_kilo'] . "</td>";
        echo "<td>" . $row['no_of_sacks'] . "</td>";
