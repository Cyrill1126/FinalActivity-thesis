...
<body class="sb-nav-fixed">
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<p>Total of Chick: " . $totalOfChick . "</p>";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Total of Chick: <?php echo $totalOfChick; ?></p>
    ...
    if ($result->num_rows > 0) {
        echo "<div class='container mt-4'>";
        echo "<h4>Chickens Records</h4>";
        echo "<table class='table'>";
        echo "<thead>";
        echo "<tr>";
        echo "<th>Date</th>";
        echo "<th>Price</th>";
        echo "<th>Quantity of Chick</th>";
        echo "<th>No. of Tray</th>";
        echo "<th>Total No. of Chick</th>";
        echo "<th>Total</th>";
        echo "</tr>";
        echo "</thead>";
        echo "<tbody>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row['trays'] . "</td>";
            echo "<td>" . $row['total_chick'] . "</td>";
