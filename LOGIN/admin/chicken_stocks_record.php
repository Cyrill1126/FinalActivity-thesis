...
$sql = "SELECT * FROM chicken_stocks";
$result = $conn->query($sql);


if ($result->num_rows > 0) {
    echo "<div class='container mt-4'>";
    echo "<h2>Chicken Stocks</h2>";
    echo "<table class='table table-bordered table-striped'>";
    echo "<thead class='thead-light'>";
    echo "<tr><th>ID</th><th>Date</th><th>Chicken Pen</th><th>No of Pen</th><th>Total Chicken</th></tr>";
    echo "</thead>";
    echo "<tbody>";
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row['id'] . "</td>";
        echo "<td>" . $row['date'] . "</td>";
        echo "<td>" . $row['chicken_pen'] . "</td>";
        echo "<td>" . $row['no_of_pen'] . "</td>";
        echo "<td>" . $row['total_chicken'] . "</td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
