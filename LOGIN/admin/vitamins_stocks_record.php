...
$sql = "SELECT * FROM vitamins_stocks";
$result = $conn->query($sql);


if ($result->num_rows > 0) {
    echo "<div class='container mt-4'>";
    echo "<h2>Vitamins Stocks</h2>";
    echo "<table class='table table-bordered table-striped'>";
    echo "<thead class='thead-light'>";
    echo "<tr><th>ID</th><th>Date</th><th>Vitamins Name</th><th>Quantity</th><th>Expiration Date</th></tr>";
    echo "</thead>";
    echo "<tbody>";
